  ...
  <view class="yd-page-container">
    ...
    <view class="  bg-white mb-20rpx">
      ...
      <view class="p-30rpx">
        ...
        <view class="flex justify-between mt-20rpx opacity-60">
          <view class="flex">
            <view class="flex items-center justify-between">
              <wd-icon name="download1" size="26rpx"></wd-icon>
              <view class="ml-5rpx text-24rpx">8</view>
            </view>
            <view class="flex items-center justify-between ml-30rpx">
              <wd-icon name="browse" size="30rpx"></wd-icon>
              <view class="ml-5rpx text-24rpx">8</view>
            </view>
          </view>
          <view class="text-24rpx">2024-09-19 21:21:29</view>
        </view>
        <view class="flex items-center mt-20rpx opacity-60 bg-[#f1f1f1] rounded-8rpx py-12rpx px-15rpx">
          <wd-icon name="discount-filled" size="30rpx"></wd-icon>
        ...
        <view class="mt-30rpx flex items-center justify-between">
          <view class="flex items-center">
            ...
            <view>
              <view class="text-26rpx opacity-80 ml-10rpx">小野猫</view>
              <view class="text-22rpx opacity-60 ml-10rpx">@xsdwa_1223132</view>
            </view>
          </view>
          <view class="text-primary text-24rpx">
    ...
    <view class="foot-box bg-white border-top border-bottom">
      <view class="flex justify-between items-center px-30rpx py-21rpx">
        <view class="flex items-center opacity-70">
          <wd-icon name="thumb-up" size="30rpx"></wd-icon>
          <text class="text-28rpx ml-10rpx">23</text>
        </view>
        <view class="flex items-center opacity-70">
          <wd-icon name="books" size="30rpx"></wd-icon>
          <text class="text-28rpx ml-10rpx">123</text>
        </view>
